...
tab1 = tabE.loc[
    ...
    ["H05", "H02", "H04", "H18", "MO012022", "MO122022", "MO012023"],
]
...
tab2 = tabE.loc[
    ...
    ["H02", "H05", "H04", "H18", "MO012022", "MO122022", "MO012023"],
]
...
tab3 = tabE.loc[
    ...
    ["H02", "H04", "H05", "H18", "MO012022", "MO122022", "MO012023"],
]
...
total_other_metals = sub_other_metals.sum()
...
weight_agri = ((total_agri / total_exports_proper) * 100).round(2)
weight_agri

weight_ores = ((total_ores / total_exports_proper) * 100).round(2)
weight_ores

weight_bev = ((total_bev / total_exports_proper) * 100).round(2)
weight_bev

weight_transportable = ((total_transportable / total_exports_proper) * 100).round(2)
weight_transportable

weight_metal = ((total_metal_products / total_exports_proper) * 100).round(2)
weight_metal

weight_all_items = (
    weight_agri + weight_ores + weight_bev + weight_transportable + weight_metal
)

weight_iron_ores = ((iron_ores / total_exports_proper) * 100).round(2)
weight_non_ferrous = ((non_ferrous / total_exports_proper) * 100).round(2)

weight_basic_iron = ((sub_basic_metals[0] / total_exports_proper) * 100).round(2)
weight_precious_metals = ((sub_basic_metals[1] / total_exports_proper) * 100).round(2)
weight_semi_finished = ((sub_basic_metals[2] / total_exports_proper) * 100).round(2)
weight_product_iron = ((sub_basic_metals[3] / total_exports_proper) * 100).round(2)


weight_basic_metals = ((total_basic_metals / total_exports_proper) * 100).round(2)
# Checking the weight
weight_basic_iron + weight_precious_metals + weight_semi_finished + weight_product_iron

weight_fabric_metal = ((sub_other_metals[0] / total_exports_proper) * 100).round(2)
weight_gen_purpose = ((sub_other_metals[1] / total_exports_proper) * 100).round(2)
weight_motor = ((sub_metal_products[2] / total_exports_proper) * 100).round(2)
weight_machine_equip = ((sub_other_metals[3] / total_exports_proper) * 100).round(2)
weight_spec_purpose = ((sub_other_metals[4] / total_exports_proper) * 100).round(2)
weight_transport = ((sub_other_metals[5] / total_exports_proper) * 100).round(2)

weight_other_metals = ((total_other_metals / total_exports_proper) * 100).round(2)
# not the same
(
    weight_fabric_metal
    + weight_gen_purpose
