...
exports_weight = (
    ...
    .query('datetime >= "2021-01-01" & datetime <= "2023-01-02"')
    .dropna()
)

test = exports_weight.groupby(["H03", "H05"])["Amount"].sum().to_frame().reset_index()
...
for index, row in test.iterrows():
    if row["H03"] == f"UVI4{la}000":
        # Select specific columns and convert to a single-row DataFrame
        col_sel = (
            row[["H03", "H05", "H02", "H04", "MO012022", "MO122022", "MO012023"]]
            .to_frame()
            .T
        )
